...
;(function () {
  ...
  // --------------------------------------------------------------------
  // Get data
  // Replace 'api.php' with the correct URL to your PHP file
  function getOriginalWorkedHour() {
    fetch(`../helpers/api_request.php`)
  ...
  if (
    typeof totalRevenueChartEl2 !== undefined &&
    totalRevenueChartEl2 !== null
  ) {
    const totalRevenueChart = new ApexCharts(
      totalRevenueChartEl2,
      totalRevenueChartOptions2
    )
    totalRevenueChart.render()
  }
