...
<div class="row">
 <div class="col-md-12">
  <div class="card mb-4">
   ...
   <!-- Account -->
   <div class="card-body">
    <form action="../helpers/edit_photo_process.php" enctype="multipart/form-data" method="post" class="d-flex align-items-start align-items-sm-center gap-4 justify-content-center">
